...
(function(factory){
	...
	var datepickerCalendar = [
		...
		'		<div class="datepicker-month-fast-next pull-right" role="button" aria-labelledby="datepicker-bn-fast-next-label-CALENDARID" tabindex="0"><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-right"></use></svg><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-right"></use></svg></div>',
		'		<div class="datepicker-month-next pull-right" role="button" aria-labelledby="datepicker-bn-next-label-CALENDARID" tabindex="0"><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-right"></use></svg></div>',
		'		<div class="datepicker-month-fast-prev pull-left" role="button" aria-labelledby="datepicker-bn-fast-prev-label-CALENDARID" tabindex="0"><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-left"></use></svg><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-left"></use></svg></div>',
		'		<div class="datepicker-month-prev pull-left" role="button" aria-labelledby="datepicker-bn-prev-label-CALENDARID" tabindex="0"><svg class="icon"><svg class="icon"><use xlink:href="/dist/svg/sprite.svg#it-chevron-left"></use></svg></div>',

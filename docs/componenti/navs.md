...
Change the horizontal alignment of your nav with [flexbox utilities]({{ site.baseurl }}/docs/utilities/grid/#horizontal-alignment). By default, navs are left-aligned, but you can easily change them to center or right aligned.
...
Add dropdown menus with a little extra HTML and the [dropdowns JavaScript plugin]({{ site.baseurl }}/docs/componenti/dropdowns/#usage).
...
If you're building our JavaScript from source, it [requires `util.js`]({{ site.baseurl }}/docs/come-iniziare/javascript/#util).

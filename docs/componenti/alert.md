...
{% capture callout %}
Nel markup del componente il contenuto va incluso in un tag `<p>`. L'icona d'ora in poi va definita esplicitamente con il tag `<svg>` e la corretta semantica per l'accessibilità. 

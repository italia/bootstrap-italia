...
## Hero image
Il componente Hero, è contenuto all'interno del div `.it-hero-wrapper` a cui si andranno ad aggingere le classi che ne varieranno l'aspetto.
...
Esempio di Hero con tutti i compnenti testuali
...
## Hero con testi ed immagine di background
...
## Hero con testi ed immagine di background con overlay di colore primario
...
## Hero con con overlay + filtro di colore primario
...
## Hero teso , immgine e margine negativo per contenuti sovrapposti

  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="notification with-icon" role="alert" aria-labelledby="not2-title" id="not2">
        <h2 id="not2-title" class="notification-title d-flex align-items-center no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-info-circle"></use></svg>Titolo notifica</h2>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="notification with-icon success" role="alert" aria-labelledby="not2a-title" id="not2a">
        <h2 id="not2a-title" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-check-circle"></use></svg>Titolo notifica</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…</p>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="notification with-icon success dismissable" role="alert" aria-labelledby="not2dms-title" id="not2dms">
        <h2 id="not2dms-title" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-check-circle"></use></svg>Titolo notifica</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…</p>
        <button type="button" class="btn notification-close">
          <svg class="icon"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-close"></use></svg>
          <span class="visually-hidden">Chiudi notifica: Titolo notifica</span>
  ...
  <div class="row mb-5">
    <div class="col-12 col-md-6 mb-4 mb-md-0">
      ...
      <div class="notification with-icon success" role="alert" aria-labelledby="not1b-title" id="not1b">
        <h2 id="not1b-title" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-check-circle"></use></svg>Titolo notifica</h2>
      </div>
    </div>
    <div class="col-12 col-md-6">
      <p><strong>Errore</strong></p>
      <div class="notification with-icon error" role="alert" aria-labelledby="not2b-title" id="not2b">
        <h2 id="not2b-title" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-close-circle"></use></svg>Titolo notifica</h2>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-12 col-md-6 mb-4 mb-md-0">
      ...
      <div class="notification with-icon info" role="alert" aria-labelledby="not3b-title" id="not3b">
        <h2 id="not3btitle" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-info-circle"></use></svg>Titolo notifica</h2>
      </div>
    </div>
    <div class="col-12 col-md-6">
      <p><strong>Precauzione</strong></p>
      <div class="notification with-icon warning" role="alert" aria-labelledby="not4b-title" id="not4b">
        <h2 id="not4b-title" class="notification-title no_toc"><svg class="icon icon-sm me-2"><use href="{{ site.baseurl }}/dist/svg/sprites.svg#it-error"></use></svg>Titolo notifica</h2>
      </div>
    </div>
  </div>
</div>

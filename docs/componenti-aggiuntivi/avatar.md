...
Per utilizzare un'icona all'interno degli Avatar è sufficiente includere il codice dell'icona prescelta dalla <a href="{{ site.baseurl }}/docs/utilities/icone/">libreria icone</a> e indicarne il colore con una delle classi disponibili.
...
Utilizzando un componente <a href="{{ site.baseurl }}/docs/componenti/link-list/">Link list</a> con l'aggiunta della classe `.avatar-group` si ottiene una lista verticale con Avatar affiancati da link e testi.
  ...
  <ul class="link-list avatar-group">
    <li>
      <a class="list-item" href="#">
        <div class="avatar size-sm"><img src="https://randomuser.me/api/portraits/men/43.jpg" alt="">
        </div>
...
<div class="link-list-wrapper">
  <ul class="link-list avatar-group">
    <li>
      <a class="list-item" href="#">
        <div class="avatar size-md"><img src="https://randomuser.me/api/portraits/men/46.jpg" alt="">
        </div>
        <span>Mario Rossi</span>
      </a>
    </li>

...
const VIMEO_OPTION_KEYS = ['autoplay', 'background', 'byline', 'color', 'controls', 'height', 'keyboard', 'loop', 'maxheight', 'maxwidth', 'muted', 'playsinline', 'portrait', 'quality', 'responsive', 'speed', 'texttrack', 'title', 'transparent', 'width']; // Since the iframe can't be touched using Vimeo's way of embedding,
...
(function (root, factory) {
  ...
  VimeoTCH.registerSourceHandler(VimeoTCH.nativeSourceHandler); // Older versions of VJS5 doesn't have the registerTech function
